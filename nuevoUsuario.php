...
if(!empty($_POST['registro_perfil_nombre']) && !empty($_POST['idiomaPerfil']) && !empty($_POST['clasificacionPerfil']) && !empty($_POST['idiomaPerfil']) && !empty($_POST['imagenId']) ){
    $nombrePerfil=$_POST['registro_perfil_nombre'];
    $clasificacionPerfil=$_POST['clasificacionPerfil'];
    $idiomaPerfil=$_POST['idiomaPerfil'];
    $imagenPerfil=$_POST['imagenId'];
    $idRegistro="0";
    $result4=$conn->query("INSERT INTO cuenta_familiar (idPerfil,nombre,idioma,clasificacion,imagen,idPrincipal) VALUES ('$idRegistro','$nombrePerfil','$idiomaPerfil','$clasificacionPerfil','$imagenPerfil','$idPrincipal')");
...
<body>
    ...
    <div class="container rounded p-5 formularioRegistro" style="background-color: #ee2b47;">
        <?php
            $result3=$conn->query("SELECT count(*) from cuenta_familiar where idPrincipal='$idPrincipal'");
            foreach($result3 as $r3){
                $encontradoConID=$r3[0];
                if($encontradoConID<$noPerfilesPrincipal){
                    ?>
                        <form method="POST">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="inputState" class="form-control" required name="idiomaPerfil">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="inputState" class="form-control" required name="clasificacionPerfil">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-1">
                                    <button type="submit" class="btn btn-primary" style="background-color: #2c2e3e;">Registrarse</button>
                                </div>
                    ...
                    echo "<center><p>Ya tienes el maximo de perfiles<br><br>";
                    echo "<a href='inicioSesion.php' class='btn btn-primary' style='background-color: #2c2e3e;'>Regresar</a></p></center>";
                }
            }
        ?>
